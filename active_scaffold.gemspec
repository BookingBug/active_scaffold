...
Gem::Specification.new do |s|
  ...
  s.summary = %q{Rails 4 Version of activescaffold supporting prototype and jquery}
  ...
  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to?(:required_rubygems_version=, true)

  #s.add_development_dependency(%q<shoulda>, [">= 0"])
  s.add_development_dependency(%q<bundler>, ["~> 1.0.0"])
  #s.add_development_dependency(%q<rcov>, [">= 0"])
  #s.add_runtime_dependency(%q<render_component_vho>, [">= 0"])
  s.add_runtime_dependency(%q<rails>, "> 3.3", "< 4.1")
end
